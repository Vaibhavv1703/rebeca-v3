...
const CustomAvatar = ({ title, subtitle, src, phone, icon, responsive }) => {
    const aWidth = window.innerWidth > 450 ? 170 : 110 
    return (
        <div className={`avatar`}>
            ...
            >
                <Avatar className="avatar-img" src={src} style={{ width: aWidth, height: aWidth, border: "3px solid #fff", zIndex: 1 }} />
            </Badge>
